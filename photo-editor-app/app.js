...
const EXIF_FIELD_DEFS = [
  ...
  { key: 'focal',    label: '焦点距離', get: d => d.FocalLengthIn35mmFilm ? `${Math.round(toNum(d.FocalLengthIn35mmFilm))}mm` : null },
