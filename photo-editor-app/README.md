...
| EXIF焼き込み | 「EXIF」タブ → 項目カード(3列グリッド、ラベル+実際の値を表示)をタップしてON/OFF(利用不可の項目は薄く無効化表示)、位置/文字サイズ/色/縁取りを変更 → プレビューに即時反映。「キャンセル」でこのタブに入った時点の設定に戻る、「適用」で確定して次へ |
...
| モザイク/アイコン | 「隠し方」カード(プレビュー付き2択)を切替え、プレビューの隠し方が変わることを確認 |
